...
export function buildEnvVars(env: OpenClawEnv): Record<string, string> {
  ...
  // Pass through OPENCLAW_GATEWAY_TOKEN to the container
  ...
  // Sever upstream telemetry and tracing
  envVars.OPENCLAW_TELEMETRY = 'disabled';
  envVars.OPENCLAW_UPDATE_CHECK = 'false';
  envVars.CHECKPOINT_DISABLE = 'true'; // Disable any startup checkins
